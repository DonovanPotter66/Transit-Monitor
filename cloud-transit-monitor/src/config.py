...
SOURCES = (
    ...
    Source("BART", "View Active Solicitations",
           ...
           record_selector="table", required_headers=("Solicitation Id", "Event Name", "Start Date", "End Date", "Status/Due Date"),
           id_headers=("solicitation id",), id_pattern=r"BARTD[- ]?[A-Z0-9]+(?:[- ][A-Z0-9]+)*",
           url_pattern=r"suppliers\.bart\.gov/psc/BRFPV91/.*AUC_RESP_INQ_AUC"),
    ...
    Source("MARTA", "MARTA Current Opportunities",
           ...
           markers=("Current Opportunities", "Current Opportunities Documents")),
    ...
    Source("RTD Denver", "RTD OpenGov Open Projects (embedded)",
           ...
           id_headers=("project id",), url_pattern=r"procurement\.opengov\.com/portal/embed/rtd-denver/project-list" ,
           verification_urls=(
    ...
    Source("SEPTA", "SEPTA Current Bids Listing",
           ...
           link_id_pattern=r"\b(?:RFP|RFQ|IFB|RFI|RFQu|Bid)\s*#?\s*[A-Z0-9-]{3,}\b"),
    Source("UTA", "UTA Solicitation Procurements",
           "https://www.rideuta.com/Doing-Business/UTA-Solicitation-Procurements", mode="links",
           link_id_pattern=r"\b(?:RFP|RFQ|IFB|RFI|SOQ)\s*#?\s*[A-Z0-9-]{3,}(?:-[A-Z0-9]+)*\b"),
    Source("Sound Transit", "Sound Transit Procurement Snapshot",
           "https://www.soundtransit.org/sites/default/files/documents/snapshot-current.pdf",
           mode="pdf", markers=("Procurement Snapshot", "Procurement ID"),
           id_headers=("procurement id",),
           id_pattern=r"(?:RP|IB|GC|CN|DB|AE)\s+\d{4}-\d{2}"),
