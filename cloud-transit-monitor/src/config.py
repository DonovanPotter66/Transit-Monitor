...
SOURCES = (
    ...
    Source("CTA", "CTA Bonfire Open Opportunities",
           ...
           record_selector="table", required_headers=("Ref. #", "Project", "Close Date"), id_headers=("Ref. #",),
    ...
    Source("RTD Denver", "RTD OpenGov Open Projects (embedded)",
           ...
           record_selector='[role="grid"]', required_headers=("Project Title", "Project ID", "Status", "Addenda", "Release Date", "Due Date"), id_headers=("Project ID",), url_pattern=r"procurement\.opengov\.com/portal/embed/rtd-denver/project-list" ,
           verification_urls=(
